...
def test_class():
    ...
    for k in dir(p):
        ...
        if type(i) == str and len(i) > 30:
            ...
            print(i, i2)
    # from parent import Base, Parent, ParentNew, Child, ChildNew, ChildBoth
    # Base()
    # _cleanup()
    # classes = [Parent, ParentNew, Child, ChildNew, ChildBoth]
    # for Kls in classes:
    #     a, b = Kls(1), Kls(1)
    #     assert a.__class__ is Kls
    #     assert b.__class__ is Kls
    #     assert a.val == b.val
    #     assert Kls.__cache_instances_factory__.info().miss == 1
